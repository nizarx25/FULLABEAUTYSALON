...
export const metadata: Metadata = {
  ...
  description:
    "صالون فلة بيوتي لإدارة خبيرة التجميل هبة صبّوح. خدمات الميكاب، التسريحات، وعناية البشرة في فندق السفير - حمص، سوريا. للحجز: 0938305491",
  keywords: [
    "صالون تجميل حمص",
    "فلة بيوتي",
    "هبة صبوح",
  ...
  openGraph: {
    ...
    description:
      "خدمات الميكاب، التسريحات، وعناية البشرة بإدارة خبيرة التجميل هبة صبّوح في فندق السفير - حمص",
    type: "website",
    locale: "ar_SY",
  },
};
